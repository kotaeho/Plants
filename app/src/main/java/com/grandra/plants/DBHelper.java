...
public class DBHelper extends SQLiteOpenHelper {
    ...
    ArrayList<Favroite_plants> favroiteplantss = new ArrayList<>();
    // DBHelper 생성자
    ...
    public String getResult() {
        ...
        while (cursor.moveToNext()) {
            ...
            favroiteplantss.add(new Favroite_plants(cursor.getString(0),cursor.getString(1),cursor.getString(2)));
            for (Favroite_plants plants : favroiteplantss) {
                Log.v("태그", "이름: " + plants.getName() + ", 번호: " + plants.getNum() + ", 이미지주소: " + plants.getImageUrl());
            }
    ...
    public ArrayList<Favroite_plants> getFavroiteplantsss(){
        return favroiteplantss;
    }
